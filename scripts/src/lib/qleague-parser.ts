...
const TEAM_ALIASES: Record<string, string> = {
  ...
  水俣ユニオンフットボールクラブウイメン: "水俣ユニオンフットボールクラブウィメン",
  水俣ユニオンフットボールクラブウィメン: "水俣ユニオンフットボールクラブウィメン",
  // GoalNote は「高校」、q-league は「高等学校　」（全角スペース入り）で書く
  柳ヶ浦高校女子サッカー部: "柳ヶ浦高等学校　女子サッカー部",
  柳ヶ浦高等学校女子サッカー部: "柳ヶ浦高等学校　女子サッカー部",
};
